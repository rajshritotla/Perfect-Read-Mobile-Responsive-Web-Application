...
<html lang="en">
    ...
    <!------------------------------------HEADER-------------------------------------------------------------------------------------------------->
        ...
        <div class="belowheader">
            ...
            <form class="form-horizontal" method="post" action="upload_success.php">
        
                <div class="form-group">
                    <label class="control-label">Hey!! Great work. Thanks for sharing with your fellow readers. Do choose best & apt filters so that you can earn maximum views.</label>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control col-sm-2" id="genre" name="genre" required>
                            ...
                            <option value="<?php echo $row['genre_id'] ?>"><?php echo ucwords($row['genre_name']); ?></option>
                ...
                <div class="form-group">
                    <label class="control-label col-sm-10">Content Type:</label>
                    <div class="col-sm-10">
                        <select class="form-control col-sm-2" id="contenttype" name="contenttype" required="required">
                ...
                <div class="form-group">
                    ...
                    <label class="control-label col-sm-10">Title</label><br>
                    <small class="control-label col-sm-10">Tip: Keep it short & simple!</small>
                    
                    <div class="col-sm-10">
                        <input  class="form-control col-sm-2" type="text" name="uploadtitle" id="uploadtitle" required="required">
                ...
                <div class="form-group">
                    ...
                    <label class="control-label col-sm-10">Abstract</label><br>
                    <small class="control-label col-sm-10">A small walk through your peice, overview.</small>
                    
                    <div class="col-sm-10">
                        <input  class="form-control col-sm-2" type="text" name="abstract" id="abstract" required="required">
                ...
                <div class="form-group">
                    ...
                    <label class="control-label col-sm-10">Content</label><br>
